...
function add_item_to_table(data, itemid, merge_invoice, bill_expense) {
    ...
    console.log("[main.js][add_item_to_table]");
    ...
    get_taxes_dropdown_template(tax_name, data.taxname).done(function(tax_dropdown) {
        ...
        table_row += '<td readonly="readonly" class="bold description"><textarea name="newitems[' + item_key + '][description]" class="form-control" rows="5">' + data.description + '</textarea></td>';
