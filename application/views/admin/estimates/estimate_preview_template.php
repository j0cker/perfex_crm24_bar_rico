         ...
         <div class="row">
            ...
            <div class="col-md-9">
               ...
               <div class="pull-right _buttons">
                  ...
                  <a style="display: none;" href="#" class="estimate-send-to-client btn btn-default btn-with-tooltip" data-toggle="tooltip" title="<?php echo $_tooltip; ?>" data-placement="bottom"><span data-toggle="tooltip" data-title="<?php echo $_tooltip_already_send; ?>"><i class="fa fa-envelope"></i></span></a>
                  <?php } ?>
                  ...
                  <div style="display: none;" class="btn-group pull-right mleft5">
