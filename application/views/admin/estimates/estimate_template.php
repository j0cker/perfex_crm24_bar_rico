      ...
      <div class="row">
         <div class="col-md-12">
            ...
            <div class="form-group">
               ...
               <input type="text" id="reference_no" name="reference_no" class="form-control" autofocus="1" value="Barra1" aria-invalid="false" readonly="readonly">
                                 
            </div>

            <div style="display: none;" class="f_client_id">
             <div class="form-group select-placeholder">
                ...
                <option value="1" selected>Clientes en General</option>
                <!--
            ...
            <div class="row">
               ...
               <div class="col-md-6">
                  <div class="form-group" app-field-wrapper="date">
                     <label for="date" class="control-label"> <small class="req text-danger">* </small>Fecha del presupuesto</label>
                     <div class="input-group date">
                        <input readonly="readonly" type="text" id="date" name="date" class="form-control datepicker" value="<?PHP echo $value; ?>" autocomplete="off">
   ...
   <div class="row">
      <div class="col-md-12 mtop15">
         ...
         -->
            ...
            <div style="padding-right: 20%; position: fixed !important; margin: 0 0 0 0 !important; width: 100%;" class="btn-bottom-toolbar text-right">
