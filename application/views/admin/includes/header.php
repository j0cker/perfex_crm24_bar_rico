...
<div id="header">
      ...
      <div class="mobile-menu">
         ...
         <div class="mobile-navbar collapse" id="mobile-collapse" aria-expanded="false" style="height: 0px;" role="navigation">
            <ul class="nav navbar-nav">
               ...
               <li style="display: none;" class="header-my-timesheets"><a href="<?php echo admin_url('staff/timesheets'); ?>"><?php echo _l('my_timesheets'); ?></a></li>
   ...
   <?php if(is_staff_member()){ ?>
      <li style="display: none;" class="icon header-newsfeed">
   ...
   <?php } ?>
   <li style="display: none;" class="icon header-todo">
   ...
   <li style="display: none;" class="icon header-timers timer-button" data-placement="bottom" data-toggle="tooltip" data-title="<?php echo _l('my_timesheets'); ?>">
