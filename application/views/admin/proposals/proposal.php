            ...
            <div class="panel_s">
               <div class="panel-body">
                  <div class="row">
                     ...
                     <div class="col-md-12">
                        ...
                        <div class="form-group">
                          ...
                          <label class="control-label"> <small class="req text-danger">* </small>Zona del Bar</label>
                          <input type="text" id="subject" name="subject" class="form-control" autofocus="1" value="Barra1" aria-invalid="false" readonly="readonly">
                        
                        </div>

                        <div style="display: none;" class="form-group select-placeholder">
                        ...
                        <div style="display: none;" class="form-group select-placeholder" id="rel_id_wrapper">
                           ...
                           <div id="rel_id_select">
                              <select name="rel_id" id="rel_id" class="ajax-search" data-width="100%" data-live-search="true" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                <option value="Clientes en General" selected>Clientes en General</option>
                              </select>
                           </div>
                        </div>
                           ...
                           <div class="row">
                            ...
                            <div class="col-md-6">
                              ...
                              <div class="form-group" app-field-wrapper="date">
                                <label for="date" class="control-label"> <small class="req text-danger">* </small>Fecha</label>
                                <div class="input-group date">
                                    <input type="text" id="date" name="date" class="form-control datepicker" value="<?PHP echo _d(date('Y-m-d')); ?>" autocomplete="off" readonly="readonly">
                        ...
                        <?php echo render_custom_fields('proposal',$fc_rel_id); ?>
                         <div style="display: none;" class="form-group no-mbot">
                        ...
                        <div style="display: none;" class="form-group mtop10 no-mbot">
                     ...
                     <div style="display: none;" class="col-md-6">
                        ...
                        <div class="form-group" app-field-wrapper="proposal_to">
                          <label for="proposal_to" class="control-label"> <small class="req text-danger">* </small>Para</label>
                          <input type="text" id="proposal_to" name="proposal_to" class="form-control" value="Clientes en General">
                        </div>
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <?php $value = (isset($proposal) ? $proposal->email : 'info@boogapp.mx'); ?>
                  ...
                  <div class="btn-bottom-toolbar bottom-transaction text-right">
                    ...
                    <!--  se tuvo que quitar el envío de correos debido al performance -->
