   ...
   <div class="panel-body">
      <div class="horizontal-scrollable-tabs preview-tabs-top">
         ...
         <div class="horizontal-tabs">
            <ul class="nav nav-tabs nav-tabs-horizontal mbot15" role="tablist">
               ...
               <li style="display: none;" role="presentation" class="tab-separator">
               ...
               <li style="display: none;" role="presentation" data-toggle="tooltip" title="<?php echo _l('emails_tracking'); ?>" class="tab-separator">
               ...
               <li style="display: none;" role="presentation" data-toggle="tooltip" data-title="<?php echo _l('view_tracking'); ?>" class="tab-separator">
      ...
      <div class="row">
         ...
         <div class="col-md-9 text-right _buttons proposal_buttons">
            ...
            <a style="display: none;" href="#" class="btn btn-default btn-with-tooltip" data-target="#proposal_send_to_customer" data-toggle="modal"><span data-toggle="tooltip" class="btn-with-tooltip" data-title="<?php echo _l('proposal_send_to_email'); ?>" data-placement="bottom"><i class="fa fa-envelope"></i></span></a>
         ...
         <div class="col-md-12">
            <div class="tab-content">
               <div role="tabpanel" class="tab-pane active" id="tab_proposal">
                     ...
                     <div class="col-md-12">
                        <div class="alert alert-info">
                           <?php echo _l('accepted_identity_info',array(
                              ...
                              '<b>'.$proposal->acceptance_firstname . ' ' . $proposal->acceptance_lastname . '</b> (<a style="display: none;" href="mailto:'.$proposal->acceptance_email.'">'.$proposal->acceptance_email.'</a>)',
                  ...
                  <div class="tab-content">
                     <div role="tabpanel" class="tab-pane ptop10 active" id="tab_proposals">
                        <div id="proposals-preview">
                           <div class="col-md-12">
                  ...
                  <?php } ?>
                  <div style="display: none;" class="editable proposal tc-content" id="proposal_content_area" style="border:1px solid #d2d2d2;min-height:70px;border-radius:4px;">
