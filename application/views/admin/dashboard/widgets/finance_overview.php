         ...
         <div class="panel-body">
            ...
            <div class="row home-summary">
               <?php if(has_permission('invoices','','view') || has_permission('invoices','','view_own') || get_option('allow_staff_view_invoices_assigned') == 1 && staff_has_assigned_invoices()){
                  ?>
                  <div style="display: none !important;" class="col-md-6 col-lg-4 col-sm-6">
                     <div class="row">
                        <div class="col-md-12">
                        ...
                        <div style="display: none;" class="col-md-12 text-stats-wrapper">
                        ...
                        <div style="display: none;" class="col-md-12 text-right progress-finance-status">
                  ...
                  <div class="col-md-6 col-lg-6 col-sm-6">
                     <div class="row">
                        ...
                        foreach($estimate_statuses as $status){
                         ...
                         /*
                         filtro de status en dashboard otros ingresos
                         */
                         if($status==4){
                         ?>
                         <div class="col-md-12 text-stats-wrapper">
                  ...
                  <div class="col-md-6 col-sm-6 col-lg-6">
                     <div class="row">
                        ...
                        <?php foreach($proposal_statuses as $status){
                           ...
                           /*
                           filtro de status en dashboard comandas
                           */
                           if($status==3){
                           ?>
                           <div class="col-md-12 text-stats-wrapper">
