<?PHP
/*
Dashboard html Principal (front)
*/
?>
...
<div id="wrapper">
    ...
    <div style="display: none;" class="screen-options-btn">
    ...
    <div class="content">
        <div class="row">
            ...
            <div style="display: none !important;" class="col-md-6" data-container="middle-left-6">
                <?php render_dashboard_widgets('middle-left-6'); ?>
            </div>
            <div style="display: none !important;" class="col-md-6" data-container="middle-right-6">
            ...
            <div style="display: none !important;" class="col-md-4" data-container="right-4">
