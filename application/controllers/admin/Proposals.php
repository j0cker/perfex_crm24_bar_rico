...
class Proposals extends AdminController
{
    ...
    public function table()
    {
        ...
        log_activity('[controllers][admin][proposals]');
        ...
        */
        ...
        if ($this->input->post()) {
            ...
            if ($id == '') {
                ...
                //INSERT INTO `tblinvoices` (`clientid`, `project_id`, `number`, `date`, `duedate`, `show_quantity_as`, `currency`, `subtotal`, `total`, `adjustment`, `discount_percent`, `discount_total`, `discount_type`, `sale_agent`, `billing_street`, `billing_city`, `billing_state`, `billing_zip`, `billing_country`, `shipping_street`, `shipping_city`, `shipping_state`, `shipping_zip`, `shipping_country`, `show_shipping_on_invoice`, `terms`, `clientnote`, `status`, `adminnote`, `allowed_payment_modes`, `prefix`, `number_format`, `datecreated`, `addedfrom`, `cancel_overdue_reminders`, `custom_recurring`, `recurring`, `hash`, `include_shipping`) VALUES ('1', '0', '5', '2019-10-19', '2019-11-18', '1', '3', '25.00', '25.00', '0.00', '0.00', '0.00', '', '0', '', '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, 1, '', '', 1, '', 'a:1:{i:0;s:1:\"1\";}', 'INV-', '1', '2019-10-19 18:36:17', '1', 0, 0, 0, '05057d4c5455e0da83bc009d2718e7d9', 0)
    ...
    {
        log_activity('convert_to_invoice: ' . $id);
