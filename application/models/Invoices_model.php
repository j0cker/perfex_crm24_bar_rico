...
class Invoices_model extends App_Model
{
    ...
    public function get_invoices_total($data)
    {
        ...
        /*
        Adaptación valor total de otros ingresos y comandas en dashboard
        */
        ...
        $result['due']        = 100; //invoices la quitamos
        $result['paid']       = $proposals[0]['totalIncome'];
        $result['overdue']    = $estimates[0]['totalIncome'];
    ...
    public function add($data, $expense = false)
    {
        ...
        //log_activity('convert_to_invoice: ' . $this->db->last_query());
