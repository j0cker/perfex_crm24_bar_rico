...
$route['admin/comandas/delete/all'] = 'admin/comandas/deleteAll';
$route['admin/comandas/delete/(:any)'] = 'admin/prueba/index/$1';

//delete otros ingresos

$route['admin/otrosIngresos/delete/all'] = 'admin/otrosIngresos/deleteAll';
$route['admin/otrosIngresos/delete/(:any)'] = 'admin/otrosIngresos/index/$1';
